...
class X360CE_EmulatorApp:
    ...
    def __init__(self, root):
        ...
        # Title
        title_lbl = ctk.CTkLabel(root, text="≡ƒÄ« Controller Emulator", font=ctk.CTkFont(size=24, weight="bold"))
        ...
        ctk.CTkButton(btn_frame3, text="Γå╗", width=30, command=self.refresh_ports).pack(side="left")
        self.refresh_ports()
